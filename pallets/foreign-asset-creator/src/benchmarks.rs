...
where
	T::ForeignAsset: From<MultiLocation>,
	...
	AssetId<T>: AtLeast16BitUnsigned,
{
	...
	let foreign_asset: T::ForeignAsset = MultiLocation::parent().into();
...
benchmarks! {
	...
	change_existing_asset_type {
		...
		let foreign_asset:  T::ForeignAsset = MultiLocation::new(0, X1(GeneralIndex(0u128))).into();
